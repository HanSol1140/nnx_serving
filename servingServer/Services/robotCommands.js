...
exports.detectCollision = exports.checkCrossRoad = exports.getDivideDirection = void 0;
...
function detectCollision(robotName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // ===============================================================================================================
        // 인식한 장애물이 로봇인지 체크\
        export function checkRobotCoordinates(robotName, collision) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        export function test(robotName) {
